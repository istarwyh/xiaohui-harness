...
| 产品插件 | 固定的 `dsh-harbor-evolution@0.7.3`、`dsh-codex-auth@0.3.0`、`dsh-better-sidebar@0.15.1` 和 `dsh-personal-workbench@0.1.0`；Harbor 插件包含 `evolve-agent-with-harbor` Skill |
| 评测运行时 | 便携式 CPython 3.12、仓库内固定的 `harbor-dsh-evolution==0.7.3` 源码快照与 Harbor |
